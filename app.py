...
if st.button("Modify URL"):
    ...
    ACCESS_KEY = "672762f9-2fcf-492f-b0f0-fa9a9667c48d"
    SECRET_KEY = "be00679970176587de0377745befa932aa233ea3"
    REQUEST = {"coupangUrls": [modified_url]}
    
    authorization = generate_hmac(REQUEST_METHOD, URL, SECRET_KEY, ACCESS_KEY)
    url = "{}{}".format(DOMAIN, URL)
    response = requests.request(method=REQUEST_METHOD, url=url, headers={"Authorization": authorization, "Content-Type": "application/json"}, data=json.dumps(REQUEST))
